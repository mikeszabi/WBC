...
# binarization
th, bmask = cv2.threshold(im_eq,0,255,cv2.THRESH_BINARY_INV+cv2.THRESH_OTSU)

r=int(20)
kernel = cv2.getStructuringElement(cv2.MORPH_ELLIPSE,(r,r))
bmask2=cv2.morphologyEx(bmask, cv2.MORPH_OPEN, kernel)
...
tools.maskOverlay(im_onech,opening,0.5,1)


dist_transform = cv2.distanceTransform(opening,cv2.DIST_L2,5)

dist_transform[dist_transform<20]=0
