...
threshold=0.75
local_maxima_2 = feature.peak_local_max(fill_at_max, threshold_abs=threshold,
                                      indices=False,
...
markers_3[np.logical_or(label_inc_stop<bin_edges[i_max]-5,label_inc_stop>bin_edges[i_max]+5)]=0
